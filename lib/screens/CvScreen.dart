  ...
  fetchUser() {
    userDbRef.orderByChild('id').equalTo('0').once().then(( snapshot){
      ...
      if(userResponse!=null){
        u.add({'fName': '${userResponse[0]['first_name']}',
                          ...
                          child: Container(
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(height: 30,), // achievementsAchieveSection(),SizedBox(height: 30,),//inprogress sectionInprog(style: style)
                              ],
                            ),
                          ),
                        ),
                          ...
                          child: Container(
                            child: Column(
                              children: <Widget>[
                                ...
                                SizedBox(height:30),
                                //OLD SKILLSOldSkills(style: style),SizedBox(height: 30,),//NEW SKILLSNewSkills(style: style),
                              ],
                            ),
                          ),
                        ),
