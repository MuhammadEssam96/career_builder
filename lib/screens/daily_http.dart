...
class _DailyHttpState extends State<DailyHttp> {
  ...
  final String url = 'https://career-builder-54d16.firebaseio.com/questions.json';
  final String urlChallenge = 'https://career-builder-54d16.firebaseio.com/challenge.json';
  List<Question> qlist = [];
